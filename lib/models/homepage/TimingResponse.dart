class TimingResponse {
  int? code;
  String? status;
  TimingResponseBody? timingResponseBody;

  TimingResponse({this.code, this.status, this.timingResponseBody});

  TimingResponse.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    timingResponseBody =
        json['data'] != null ? TimingResponseBody.fromJson(json['data']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['code'] = code;
    data['status'] = status;
    if (timingResponseBody != null) {
      data['data'] = timingResponseBody!.toJson();
    }
    return data;
  }
}

class TimingResponseBody {
  Timings? timings;
  Date? date;
  Meta? meta;

  TimingResponseBody({this.timings, this.date, this.meta});

  TimingResponseBody.fromJson(Map<String, dynamic> json) {
    timings =
...
class Designation {
  ...
  Designation({this.abbreviated, expanded});
...
class Meta {
  ...
  Meta.fromJson(Map<String, dynamic> json) {
    ...
    school = json['school'];
    offset = json['offset'] != null ? Offst.fromJson(json['offset']) : null;
  }
...
class Offst {
  ...
  Offst.fromJson(Map<String, dynamic> json) {
    imsak = json['Imsak'];
    fajr = json['Fajr'];
    sunrise = json['Sunrise'];
    dhuhr = json['Dhuhr'];
