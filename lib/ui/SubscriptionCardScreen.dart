...
import 'package:linger/ui/SubscriptionGpayScreen.dart';

class SubscriptionCardScreen extends StatefulWidget {
  const SubscriptionCardScreen({Key? key}) : super(key: key);

  @override
  State<SubscriptionCardScreen> createState() => _SubscriptionCardScreenState();
}

enum SingingCharacter { lafayette, jefferson }

class _SubscriptionCardScreenState extends State<SubscriptionCardScreen>
    with baseclass {
          ...
          InkWell(
            onTap: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const SubscriptionGpayScreen()));
            },
            splashColor: Colors.transparent,
            highlightColor: Colors.transparent,
            child: Container(
