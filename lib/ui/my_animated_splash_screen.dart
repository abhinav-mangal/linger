...
class MyAnimatedSplashScreen extends StatefulWidget {
  ...
  /// Only required while using [MyAnimatedSplashScreen.withScreenFunction]
  ...
  const MyAnimatedSplashScreen._internal({
  ...
  navigator(screen) {
    Future.delayed(Duration(milliseconds: w.duration < 100 ? 100 : w.duration))
      ...
      try {
        ...
        // route.replaceNamed(RouteNames.welcomeScreen);
        context.read<ProfileCubit>().authenticate();
      } catch (msg) {
